...
public class DrawerActivity extends AppCompatActivity implements DrawerFragment.NavCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(R.id.nav_container, DrawerFragment.newInstance(), "DrawerActivity")
                    .commit();
        }
    }
    ...
    private void setupDrawerLayout(){
        ...
        // Instantiate the DrawerActivity Toggle
        ...
        // Set the Toggle on the DrawerActivity, And tell the Action Bar Up Icon to show
